...
assert.match(page, /value="partner"[\s\S]*name="return_fault"[\s\S]*name="return_partner"/);
assert.match(page, /value="unrecoverable"/);
...
assert.match(script, /action: 'partner_catalog'/);
assert.match(script, /\.15[\s\S]*\.4[\s\S]*unrecoverable/);
