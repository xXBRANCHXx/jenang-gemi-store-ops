...
marketplace_queue_expect(true, jg_store_ops_marketplace_action_enabled($regularShopeeManual + ['source_platform' => 'shopee', 'action' => 'arrange_shopee_shipment'], true), 'A regular Shopee card must allow its explicit guarded arrangement action.');
marketplace_queue_expect(true, jg_store_ops_marketplace_action_enabled($regularShopeeManual + ['source_platform' => 'shopee', 'action' => 'get_shopee_arrangement_options'], true), 'A regular Shopee card must be allowed to load its live pickup and drop-off choices.');
marketplace_queue_expect(false, jg_store_ops_marketplace_action_enabled($regularShopeeManual + ['source_platform' => 'shopee', 'action' => 'claim_order'], true), 'An unlabelled Shopee card must not enter picking before its label is stored.');
...
marketplace_queue_expect(true, jg_store_ops_marketplace_action_enabled($regularShopeeManual + ['source_platform' => 'shopee', 'action' => 'arrange_shopee_shipment'], true, true), 'The explicit Shopee fallback must remain available while unattended automation is paused.');
