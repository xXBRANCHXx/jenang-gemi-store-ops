...
marketplace_queue_expect(true, jg_store_ops_marketplace_order_visible(['platform' => 'Shopee', 'marketplaceStatus' => 'READY_TO_SHIP'], 'shopee', true), 'Hard Set must keep an unarranged order visible as an actionable exception.');
marketplace_queue_expect(true, jg_store_ops_marketplace_order_visible(['platform' => 'TikTok', 'marketplaceStatus' => 'AWAITING_SHIPMENT'], 'tiktok', true), 'A TikTok or Tokopedia unified-commerce order must never disappear when automatic arrangement fails.');
marketplace_queue_expect(true, jg_store_ops_marketplace_order_visible(['platform' => 'TikTok', 'marketplaceStatus' => 'AWAITING_COLLECTION'], 'tiktok', true), 'A label-storage failure after arrangement must remain visible for recovery.');
