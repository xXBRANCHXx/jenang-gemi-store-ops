...
assert.match(script, /pendingCompletionQueueStorageKey = 'jg-store-pending-order-completions-v1'[\s\S]*persistPendingCompletion\(payload\)[\s\S]*navigator\.sendBeacon/, 'completion must be durably queued before the best-effort beacon is attempted');
