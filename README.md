...
- The dashboard Reprint popup accepts an exact Order ID or performs live customer-profile search by username, name, phone, or email (never address). Profile results show dated shipping-label orders across Shopee, TikTok, website, and partner sources and retain the correct platform/account/package routing when the label opens.
