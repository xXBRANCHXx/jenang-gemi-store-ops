...
- Partner orders remain visible after acceptance and throughout scanning. Clicking the shipping-label print action completes the order and removes it from the Store Ops list before the system print dialog opens.
