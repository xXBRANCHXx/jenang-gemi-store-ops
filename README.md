...
- Partner orders remain visible after acceptance and throughout scanning. Printing opens the system dialog without completing the order; Store Ops removes the order only after the operator explicitly confirms that the shipping label printed correctly.
