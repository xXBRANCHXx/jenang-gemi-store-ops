...
if ($method === 'POST') {
    ...
    $validActions = ['claim_order', 'begin_fulfillment', 'release_order', 'remove_order', 'record_scan', 'complete_scan', 'label_printed', 'fulfill_order', 'reprint_label', 'arrange_instant_shipment', 'arrange_shopee_shipment'];
